...
Query.prototype.run = function(sql) {
  ...
  var promise = new Utils.Promise(function(resolve, reject) {
      // TRANSACTION SUPPORT
      // It gives problems when run querys to create stored procedures
      if (Utils._.contains(self.sql, 'BEGIN TRANSACTIONs')) {
      ...
      // It gives problems when run querys to create stored procedures
      } else if (Utils._.contains(self.sql, 'COMMIT TRANSACTIONs')) {
      ...
      // It gives problems when run querys to create stored procedures
      } else if (Utils._.contains(self.sql, 'ROLLBACK TRANSACTIONs')) {
